...
#define CERT_FILE_MITM "./Certs/fakealice.crt"
#define KEY_FILE_MITM "./Keys/fakealice_key.pem"
...
#define CERT_FILE_CLIENT_MITM "./Certs/fakebob.crt"
#define KEY_FILE_CLIENT_MITM "./Keys/fakebobpvt.pem"
...
int main()
{
    ...
    while (1)
    {
        ...
        ori_server_addr.sin_addr.s_addr = inet_addr(fhostname("alice1"));
